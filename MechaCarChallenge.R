...
# 3. Write an RScript that creates a total_summary dataframe using 
...
# 4. Write an RScript that creates a lot_summary dataframe using the group_by() and the summarize() functions to group each
